  ...
  return (
    <div>
      ...
      <section id="buy_now" class="hero hero__ico pos-rel">
        <div class="hero__bg" style={{ backgroundImage: 'assets/img/bg/hero_bg.png' }}></div>
            ...
            <div class="col col-xl-4 presale_box mx-auto mb-5">
              <div class="hero__countdown">
                ...
                <p class="text-center mb-3">
                  Your Purchased:{" "}
                  <strong class="text-white">598760.034 TKN</strong>
                </p>
                <p class="text-center mb-1">
                  Raised:{" "}
                  <strong class="text-white">$2,902,716.72 / $3,485,277</strong>
                </p>
                <div class="hero__progress mb-3">
                  <div class="progress">
                    <div
                      ...
                      aria-valuemin="0"
                      aria-valuemax="100">
                      <span class="presale_progress_hint">
                ...
                <p class="presale_error text-center">
                  Amount must be greater than 104.82575862401515 POL
                ...
                <p class="text-center">
                  ...
                  natus explicabo sed labore voluptates.
                </p>
              </div>
            </div>
          </div>
